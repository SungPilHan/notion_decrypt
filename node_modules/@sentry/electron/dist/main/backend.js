...
function getScope(options) {
    ...
    return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ release: options.release, environment: options.environment }, (hasKeys(scope._user) && { user: scope._user })), (hasKeys(scope._tags) && { tags: scope._tags })), (hasKeys(scope._extra) && { extra: scope._extra }));
}
    ...
    MainBackend.prototype._installNativeHandler = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                globalExtra = process.platform !== 'linux' ? { sentry___initialScope: JSON.stringify(getScope(this._options)) } : undefined;
